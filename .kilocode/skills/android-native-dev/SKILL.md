...
See [Design Style Guide](.agents/skills/android-native-dev/references/design-style-guide.md) for detailed style profiles.
...
| Topic | Reference |
|-------|-----------|
| Colors, Typography, Spacing, Shapes | [Visual Design](.agents/skills/android-native-dev/references/visual-design.md) |
| Animation & Transitions | [Motion System](.agents/skills/android-native-dev/references/motion-system.md) |
| Accessibility Guidelines | [Accessibility](.agents/skills/android-native-dev/references/accessibility.md) |
| Large Screens & Foldables | [Adaptive Screens](.agents/skills/android-native-dev/references/adaptive-screens.md) |
| Android Vitals & Performance | [Performance & Stability](.agents/skills/android-native-dev/references/performance-stability.md) |
| Privacy & Security | [Privacy & Security](.agents/skills/android-native-dev/references/privacy-security.md) |
| Audio, Video, Notifications | [Functional Requirements](.agents/skills/android-native-dev/references/functional-requirements.md) |
| App Style by Category | [Design Style Guide](.agents/skills/android-native-dev/references/design-style-guide.md) |
...
See [Testing](.agents/skills/android-native-dev/references/testing.md) for detailed examples, code patterns, and Gradle Managed Device configuration.

...
license: MIT
description: >
  Jetpack Compose and Compose Multiplatform (KMP/CMP) architecture and UI quality skill.
  Use for Jetpack Compose, Compose Multiplatform, Kotlin Multiplatform UI,
  desktop Compose screens, Material3, UI state, previews, accessibility,
  performance, and JavaFX-to-Compose migration tasks.
---
...
## Desktop UI Quality Contract

When working on Compose Multiplatform Desktop, do not produce mobile-first or generic Android-looking UI unless the user explicitly asks for it.

Use desktop-oriented UI principles:
- compact spacing and dense information layout where appropriate;
- clear sidebars, toolbars, panels, status bars, split panes, and dialogs;
- proper hover/disabled/loading/error states;
- consistent typography scale;
- consistent spacing tokens;
- stable resizing behavior;
- no random colors, gradients, oversized buttons, or prototype-looking forms.

...
- [`ComposeShellMetadata.kt`](../../apps/desktop-client/src/main/kotlin/com/shterneregen/securelan/desktop/compose/ComposeShellMetadata.kt) now records the Phase 11 Compose-first UX plan and JavaFX-deprecation guardrails as deterministic metadata.
